...
docker run \
	...
	-v /home/zanyxdev/git_source/my_src/docker/for-Qt5-and-Qtd6-dev/scripts/inline/build_qt5_amd64.sh:/root/build_qt.sh \
	-ti --rm zanyxdev/qt5-toolchain:latest bash
